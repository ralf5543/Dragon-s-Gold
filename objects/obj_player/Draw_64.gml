...
if (room  == rm_game) {
	...
	dpad_width = 218 * gui_zoom;
			...
			//======----- D-Pad
			draw_sprite_ext(spr_dpad, 0, ((dpad_width / 2) + player_split_x) + gui_margin, player_split_y - ((dpad_width / 2) + gui_margin), gui_zoom, gui_zoom, 0, c_white, 0.5);
		
	
		function DisplayEquipment(argument) {
			if (argument == 0) {

				var pos_x = player_split_x + (dpad_width / 2) + gui_margin;
				var pos_y = player_split_y  - (((dpad_width / 2) + (dpad_width / 3)) + gui_margin);
			
			} else if (argument == 1) {
				var pos_x = player_split_x + ((dpad_width / 2) + (dpad_width / 3)) + gui_margin;
				var pos_y = player_split_y  - ((dpad_width / 2) + gui_margin);
			} else if (argument == 2) {
				var pos_x = player_split_x + (dpad_width / 2) + gui_margin;
				var pos_y = player_split_y  - (((dpad_width / 2) - (dpad_width / 3)) + gui_margin);
			} else if (argument == 3) {
	...
	if (obj_control.start_players == 1) {
		...
		player_split_x = 0;
		player_split_y = global.surface_height;
